/*
 * AES-128 (ECB block + API in aes128.h): T-table implementation, single-thread.
 */
...
static const uint8_t ISB[256] = {
    0x52U, 0x09U, 0x6aU, 0xd5U, 0x30U, 0x36U, 0xa5U, 0x38U, 0xbfU, 0x40U, 0xa3U, 0x9eU,
    0x81U, 0xf3U, 0xd7U, 0xfbU, 0x7cU, 0xe3U, 0x39U, 0x82U, 0x9bU, 0x2fU, 0xffU, 0x87U,
    0x34U, 0x8eU, 0x43U, 0x44U, 0xc4U, 0xdeU, 0xe9U, 0xcbU, 0x54U, 0x7bU, 0x94U, 0x32U,
    0xa6U, 0xc2U, 0x23U, 0x3dU, 0xeeU, 0x4cU, 0x95U, 0x0bU, 0x42U, 0xfaU, 0xc3U, 0x4eU,
    0x08U, 0x2eU, 0xa1U, 0x66U, 0x28U, 0xd9U, 0x24U, 0xb2U, 0x76U, 0x5bU, 0xa2U, 0x49U,
    0x6dU, 0x8bU, 0xd1U, 0x25U, 0x72U, 0xf8U, 0xf6U, 0x64U, 0x86U, 0x68U, 0x98U, 0x16U,
    0xd4U, 0xa4U, 0x5cU, 0xccU, 0x5dU, 0x65U, 0xb6U, 0x92U, 0x6cU, 0x70U, 0x48U, 0x50U,
    0xfdU, 0xedU, 0xb9U, 0xdaU, 0x5eU, 0x15U, 0x46U, 0x57U, 0xa7U, 0x8dU, 0x9dU, 0x84U,
    0x90U, 0xd8U, 0xabU, 0x00U, 0x8cU, 0xbcU, 0xd3U, 0x0aU, 0xf7U, 0xe4U, 0x58U, 0x05U,
    0xb8U, 0xb3U, 0x45U, 0x06U, 0xd0U, 0x2cU, 0x1eU, 0x8fU, 0xcaU, 0x3fU, 0x0fU, 0x02U,
    0xc1U, 0xafU, 0xbdU, 0x03U, 0x01U, 0x13U, 0x8aU, 0x6bU, 0x3aU, 0x91U, 0x11U, 0x41U,
    0x4fU, 0x67U, 0xdcU, 0xeaU, 0x97U, 0xf2U, 0xcfU, 0xceU, 0xf0U, 0xb4U, 0xe6U, 0x73U,
    0x96U, 0xacU, 0x74U, 0x22U, 0xe7U, 0xadU, 0x35U, 0x85U, 0xe2U, 0xf9U, 0x37U, 0xe8U,
    0x1cU, 0x75U, 0xdfU, 0x6eU, 0x47U, 0xf1U, 0x1aU, 0x71U, 0x1dU, 0x29U, 0xc5U, 0x89U,
    0x6fU, 0xb7U, 0x62U, 0x0eU, 0xaaU, 0x18U, 0xbeU, 0x1bU, 0xfcU, 0x56U, 0x3eU, 0x4bU,
    0xc6U, 0xd2U, 0x79U, 0x20U, 0x9aU, 0xdbU, 0xc0U, 0xfeU, 0x78U, 0xcdU, 0x5aU, 0xf4U,
    0x1fU, 0xddU, 0xa8U, 0x33U, 0x88U, 0x07U, 0xc7U, 0x31U, 0xb1U, 0x12U, 0x10U, 0x59U,
    0x27U, 0x80U, 0xecU, 0x5fU, 0x60U, 0x51U, 0x7fU, 0xa9U, 0x19U, 0xb5U, 0x4aU, 0x0dU,
    0x2dU, 0xe5U, 0x7aU, 0x9fU, 0x93U, 0xc9U, 0x9cU, 0xefU, 0xa0U, 0xe0U, 0x3bU, 0x4dU,
    0xaeU, 0x2aU, 0xf5U, 0xb0U, 0xc8U, 0xebU, 0xbbU, 0x3cU, 0x83U, 0x53U, 0x99U, 0x61U,
    0x17U, 0x2bU, 0x04U, 0x7eU, 0xbaU, 0x77U, 0xd6U, 0x26U, 0xe1U, 0x69U, 0x14U, 0x63U,
...
void aes128_encrypt_block(const AES128CTX *ctx, uint8_t out[16], const uint8_t in[16])
{
    ...
    t0 = ((uint32_t)SB[(s0 >> 24) & 0xff] << 24U) ^
         ((uint32_t)SB[(s1 >> 16) & 0xff] << 16U) ^
         ((uint32_t)SB[(s2 >> 8) & 0xff] << 8U) ^ SB[s3 & 0xff];
    t0 ^= rk[0];
    t1 = ((uint32_t)SB[(s1 >> 24) & 0xff] << 24U) ^
         ((uint32_t)SB[(s2 >> 16) & 0xff] << 16U) ^
         ((uint32_t)SB[(s3 >> 8) & 0xff] << 8U) ^ SB[s0 & 0xff];
    t1 ^= rk[1];
    t2 = ((uint32_t)SB[(s2 >> 24) & 0xff] << 24U) ^
         ((uint32_t)SB[(s3 >> 16) & 0xff] << 16U) ^
         ((uint32_t)SB[(s0 >> 8) & 0xff] << 8U) ^ SB[s1 & 0xff];
    t2 ^= rk[2];
    t3 = ((uint32_t)SB[(s3 >> 24) & 0xff] << 24U) ^
         ((uint32_t)SB[(s0 >> 16) & 0xff] << 16U) ^
         ((uint32_t)SB[(s1 >> 8) & 0xff] << 8U) ^ SB[s2 & 0xff];
    t3 ^= rk[3];
...
void aes128_decrypt_block(const AES128CTX *ctx, uint8_t out[16], const uint8_t in[16])
{
    ...
    t0 = ((uint32_t)ISB[(s0 >> 24) & 0xff] << 24U) ^
         ((uint32_t)ISB[(s3 >> 16) & 0xff] << 16U) ^
         ((uint32_t)ISB[(s2 >> 8) & 0xff] << 8U) ^ ISB[s1 & 0xff];
    t0 ^= rk[0];
    t1 = ((uint32_t)ISB[(s1 >> 24) & 0xff] << 24U) ^
         ((uint32_t)ISB[(s0 >> 16) & 0xff] << 16U) ^
         ((uint32_t)ISB[(s3 >> 8) & 0xff] << 8U) ^ ISB[s2 & 0xff];
    t1 ^= rk[1];
    t2 = ((uint32_t)ISB[(s2 >> 24) & 0xff] << 24U) ^
         ((uint32_t)ISB[(s1 >> 16) & 0xff] << 16U) ^
         ((uint32_t)ISB[(s0 >> 8) & 0xff] << 8U) ^ ISB[s3 & 0xff];
    t2 ^= rk[2];
    t3 = ((uint32_t)ISB[(s3 >> 24) & 0xff] << 24U) ^
         ((uint32_t)ISB[(s2 >> 16) & 0xff] << 16U) ^
         ((uint32_t)ISB[(s1 >> 8) & 0xff] << 8U) ^ ISB[s0 & 0xff];
    t3 ^= rk[3];
...
{
    while (nbytes >= 16u) {
        aes128_encrypt_block(ctx, dst, src);
        src += 16;
        dst += 16;
        nbytes -= 16u;
    }
...
{
    while (nbytes >= 16u) {
        aes128_decrypt_block(ctx, dst, src);
        src += 16;
        dst += 16;
        nbytes -= 16u;
    }
...
static int aes128_tv_ok(void)
{
    static const uint8_t key[16] = {0x00U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x06U,
...
int main(void)
{
    ...
    LARGE_INTEGER f, a, b;
#endif
    const size_t bufsize = ((size_t)1 << 24); /* 16 MiB */
    ...
    if (!aes128_tv_ok()) {
        fprintf(stderr, "AES-128 self-test failed\n");
        return 1;
    }
...
#elif defined(CLOCK_MONOTONIC)
    {
        ...
        sec = (double)(t1.tv_sec - t0.tv_sec) + (double)(t1.tv_nsec - t0.tv_nsec) * 1e-9;
    }
#else
    {
        clock_t t0 = clock();
    ...
    printf("AES-128 ECB encrypt (single-thread, T-tables)\n");
    ...
    if (mbps < 700.0)
        printf("WARN: below 700 Mbps target\n");
    else
        printf("OK: >700 Mbps\n");
    ...
    printf("\nAES-128 ECB decrypt (single-thread, T-tables)\n");
    printf("Buffer: %zu MiB   Repeats: %zu   Bytes total: ~%.2f GiB\n",
           (size_t)(bufsize / (1024 * 1024)), repetitions, gb);
    printf("Time:   %.6f s\n", sec);
    printf("Throughput: %.2f Mbps (%.2f MB/s)\n", mbps,
